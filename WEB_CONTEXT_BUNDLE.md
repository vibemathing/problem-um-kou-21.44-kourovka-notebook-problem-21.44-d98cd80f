...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.44"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f-v1",
      "problem_contract_sha256": "c034c54417044897476230e043aa8d827b958060e4e374dd5afc8d08216c64f1",
      "problem_id": "problem:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f",
      "route_id": "route:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f-source-fidelity-01",
      "graph_id": "graph:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $W_n=A_5\\wr\\cdots\\wr A_5$ be the $n$-times iterated permutational wreath product of $A_5$ in its natural action (so $W_n$ acts on $5^n$ points), and let $W=\\varprojlim W_n$ be the inverse limit (infinite iterated wreath product of $A_5$). Does $W$ contain a finitely generated dense subgroup of subexponential growth?"
          },
          "statement_sha256": "f9e80108e6e8d88ed391830960452035d1bfec085f3b4f412bffbebca27b769f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f-root",
      "route_id": "route:um-kou-21.44-kourovka-notebook-problem-21.44-d98cd80f-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.44-3d1c99d4c4eb",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.44"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
